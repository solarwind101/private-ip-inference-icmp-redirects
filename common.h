...
// ---- CONFIG ----
const string   ATTACKER_IP       = "192.168.1.149";
const string   SERVER_IP         = "30.0.0.2";
...
const string   NEW_GW_IP         = "192.168.1.149";           // ICMP redirect new gateway (attacker)
const string   REDIRECT_SRC_MAC  = "f8:89:d2:e6:3a:07";   // src MAC in ICMP redirect Ethernet frame
                                         // empty = spoof as gateway MAC; set to override
const string   IFACE             = "wlo1";
...
// Like icmp_redirect() but dst MAC is always gw_mac - Experimental 
